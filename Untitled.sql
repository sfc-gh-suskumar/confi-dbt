...
ALTER DBT PROJECT CONFI_DB_QA.STG.STG_PROJECT SET DEFAULT_TARGET = 'qa';  
------------------------
-- Deploy DDS project
...
ALTER DBT PROJECT CONFI_DB_QA.DDS.DDS_PROJECT SET DEFAULT_TARGET = 'qa';
...
CREATE OR REPLACE DBT PROJECT CONFI_DB_QA.ADS.ADS_PROJECT
  ...
  ALTER DBT PROJECT CONFI_DB_QA.ADS.ADS_PROJECT SET DEFAULT_TARGET = 'qa';
